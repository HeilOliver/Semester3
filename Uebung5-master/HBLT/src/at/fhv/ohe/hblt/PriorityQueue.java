 ...
 *
 * Created by Oliver H on 22.11.2017.
 */
public class PriorityQueue <T> {
    ...
    /**
     * Return the deque element with the highest priority and delete it from the Priority Queue
     *
     ...
     * (In other words, returns {@code true} if {@link #deque} would
